    ...
    <>
      <div id="main-content" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 p-20">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-16">
            <p className="text-md font-mediumtext-justify leading-relaxed">
            ...
            <p className="mt-8 text-md font-mediumtext-justify leading-relaxed">
            ...
            <div className="mt-24">
              <p className="text-2xl font-bold text-left mb-4">Links</p>
              ...
              <a
                href="https://soundcloud.com/user-6456532"
                rel="noreferrer"
                className="mr-2 text-sm font-bold text-blue-500 hover:underline mr-6">
                Soundcloud
              </a>
              ...
              <a
                href="https://www.youtube.com/@VictorAnderssen"
                rel="noreferrer"
                className="mr-2 text-sm font-bold text-blue-500 hover:underline mr-6">
                YouTube
              </a>
